          ...
          <div className="container mx-auto">
            {!selectedState ? (
              ...
              <>
                ...
                {/* Single row layout: 2nd, 1st, 3rd order - all same size */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 items-start">
                  {/* Reorder: show 2nd place first, 1st place middle, 3rd place last */}
                  {[1, 0, 2].map((originalIndex) => {
                    const listing = topListings[originalIndex]
                        ...
                        <div className="absolute -top-4 left-6 z-10">
                          <div className={`px-4 py-2 rounded-full flex items-center gap-2 shadow-xl ${
                            ...
                            <span className="font-bebas text-lg tracking-wide">
                              {originalIndex === 0 ? '#1 TOP RATED' : originalIndex === 1 ? '#2 GUNSMITH' : '#3 GUNSMITH'}
                            </span>
                          </div>
                        </div>
                        
                        {/* Card with special styling for #1 */}
                        <div className={`mt-3 ${originalIndex === 0 ? 'ring-2 ring-gunsmith-gold' : ''}`}>
